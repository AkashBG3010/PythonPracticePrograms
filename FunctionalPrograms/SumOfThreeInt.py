def addArrayElements(num):  # Function to add elements into an array
    ...
    tripletCalculation(arr)


def tripletCalculation(arr):        # Function to calculate triplets of entered array
...
addArrayElements(num)       # Function Calling
